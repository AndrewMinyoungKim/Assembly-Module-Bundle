...
CONFIG_COUNTDOWN:	LDR	R0, =0xFFFEC600
					LDR	R1, =2000000
					STR	R1, [R0]
...
CONFIG_TIMER:     LDR	R0, =0xFF202000
					LDR	R1, =25000000
					STR	R1, [R0, #0x8]
					LSR	R1, #16
					STR	R1, [R0, #0xC]
...
CHECK_KEYS: 	CMP		R5, #73
				BEQ		SERVICE_KEYS  			     		// if not recognized, stop here
    			LDR		R0, =0xFF202000
				MOV	R3, #0
				STR	R3, [R0]
...
SERVICE_KEYS:	LDR	R0, =0xFF202004
				MOV	R1, #0b1011
				LDR	R1, [R0]
